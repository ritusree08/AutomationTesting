...
public class CreateOpportunityNeg {

	@Test
	
	public void CreateOpportunityNegative() {
		...
		//	driver.findElement(By.xpath("//input[@maxlength='120']")).sendKeys("xyz1");//not giving input to opportunity name
